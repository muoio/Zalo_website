(function () {
    ...
    */
    ...
    function t() {
        for (var a = u, b = {}, c = 0; c < a.length; ++c) b[a[c]] = c;
        return b
    }
    ...
    var G = /:[0-9]+$/,
        J = function (a, b) {
            ...
            if ("protocol" === b || "port" === b) a.protocol = H(a.protocol) || H(B.location.protocol);
            "port" === b ? a.port = String(Number(a.hostname ? a.port : B.location.port) || ("http" === a.protocol ? 80 : "https" === a.protocol ? 443 : "")) : "host" === b && (a.hostname = (a.hostname || B.location.hostname).replace(G, "").toLowerCase());
            return I(a, b)
        },
        I = function (a, b, c) {
            var d = H(a.protocol);
            ...
            switch (b) {
                ...
                case "protocol":
                    ...
                    break;
                case "host":
                    a = a.hostname.replace(G, "").toLowerCase();
    ...
    function ja(a, b, c) {
        ...
        if (C && C.replaceState) {
            var e = Q("_gl");
            if (e.test(b) || e.test(c)) a = J(a, "path"), b = d(b, "?"), c = d(c, "#"), C.replaceState({}, void 0, "" + a + b + c)
        }
    }
    var T = function (a) {
        try {
    ...
    function Y(a, b, c, d) {
        c.href && (a = V(a, b, c.href, void 0 === d ? !1 : d), A.test(a) && (c.href = a))
    }
    ...
    function X(a, b, c) {
        if (c && c.action) {
            ...
            } else "post" === d && (a = V(a, b, c.action), A.test(a) && (c.action = a))
        }
    }
...
(function () {
    ...
    var bd = function (a) {
        ...
        ge = function (a, b, c) {
            1 <=
                100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j99", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(bd(!0) + "/u/d", a.join("&"), ua))
        };
    var qc = function () {
            ...
            if (e) {
                ...
                switch (e) {
                    case 1:
                        ...
                        "t0" != b && (g.target =
                            b);
                        G(String(a.get("trackingId"))) || (g.clientId = String(a.get(Q)), g.ka = Number(a.get(n)), c = c.palindrome ? r : q, c = (c = M.cookie.replace(/^|(; +)/g, ";").match(c)) ? c.sort().join("").substring(1) : void 0, g.la = c, g.qa = E(P(a, kb), "gclid"));
                        break;
                    case 2:
                        if (20 <= nf) return;
                        nf++;
    ...
    var H = {},
        ...
        Ne = function (a) {
            return !H[P(a, Na)] && void 0 === a.get(Ie) && void 0 === a.get(fa) && void 0 === a.get(gd) && void 0 === a.get(oe)
        },
        re = function (a, b) {
            var c = new ee,
                d = function (g) {
